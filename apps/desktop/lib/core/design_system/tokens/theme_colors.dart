...
class ThemeColors {
  ...
  Color get backgroundGradientStart => isDark 
    ? const Color(0xFF142019)  // Lighter forest center
    : const Color(0xFFF8FCFA); // Lighter mint center
  
  Color get backgroundGradientMiddle => isDark 
    ? const Color(0xFF0F1C14)  // Main forest
    : const Color(0xFFF5FBF8); // Main mint
    
  Color get backgroundGradientEnd => isDark 
    ? const Color(0xFF0A140F)  // Darker forest edges
  ...
  // Interactive states
  Color get hover => primary.withOpacity(0.04);
  Color get pressed => primary.withOpacity(0.08);
