...
class AppTheme {
  ...
  static const Color lightBackground =
      Color(0xFFF5FBF8); // Soft mint background
  static const Color lightBackgroundGradientStart =
      Color(0xFFF8FCFA); // Lighter mint center
  static const Color lightBackgroundGradientMiddle =
      Color(0xFFF5FBF8); // Main mint
  static const Color lightBackgroundGradientEnd =
      Color(0xFFE8F3ED); // Darker mint edges
  static const Color lightForeground =
      Color(0xFF1E3B2B); // Deep forest green text
  static const Color lightCard =
      Color(0xFFF7FCFA); // Lighter mint background/cards
  static const Color lightCardForeground =
      Color(0xFF1E3B2B); // Deep forest green text
  static const Color lightPrimary =
      Color(0xFF1E3B2B); // Deep forest green primary
  static const Color lightPrimaryForeground =
      Color(0xFFF5FBF8); // Soft mint on primary
  ...
  static const Color lightMutedForeground =
      Color(0xFF4A6B5A); // Muted forest green text
  static const Color lightAccent = Color(0xFF6B9080); // Sage green accent
  static const Color lightAccentForeground =
      Color(0xFFFFFFFF); // White text on accent
  ...
  static const Color darkBackground =
      Color(0xFF0F1C14); // Deep forest background
  static const Color darkBackgroundGradientStart =
      Color(0xFF142019); // Lighter forest center
  static const Color darkBackgroundGradientMiddle =
      Color(0xFF0F1C14); // Main forest
  static const Color darkBackgroundGradientEnd =
  ...
  static const Color darkPrimaryForeground =
      Color(0xFF0F1C14); // Dark forest on mint
  static const Color darkAccent =
      Color(0xFF8DBF9E); // Brighter sage accent for dark theme
  static const Color darkAccentForeground =
      Color(0xFF0F1C14); // Dark forest text on accent
