  ...
  Widget _buildSidebarItem(String label, IconData icon, bool isActive, VoidCallback onTap, {bool enabled = true}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: isActive ? Border.all(color: SemanticColors.primary.withValues(alpha: 0.2)) : null,
      ),
      child: ListTile(
        enabled: enabled,
        leading: Icon(
          ...
          color: enabled
            ...
            : SemanticColors.onSurfaceVariant.withValues(alpha: 0.3),
        ),
        title: Text(
          label,
          style: TextStyle(
            ...
            color: enabled
              ...
              : SemanticColors.onSurfaceVariant.withValues(alpha: 0.5),
          ),
        ),
