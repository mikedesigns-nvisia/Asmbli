...
class _ContextLibraryScreenState extends ConsumerState<ContextLibraryScreen> {
  ...
  void _editDocument(ContextDocument document) {
    // TODO: Open edit mode for the document
  }
...
class _AgentAssignmentModalState extends State<_AgentAssignmentModal> {
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          color: agent.isActive 
                              ...
                              : ColorTokens.mutedForeground.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(BorderRadiusTokens.sm),
                        ),
                        child: Icon(
                        ...
                        children: [
                          ...
                          if (!agent.isActive)
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: ColorTokens.mutedForeground.withOpacity(0.1),
                                borderRadius: BorderRadius.circular(BorderRadiusTokens.sm),
                              ),
                              child: Text(
                                'INACTIVE',
                      ...
                      selected: isSelected,
                      selectedTileColor: ColorTokens.primary.withOpacity(0.05),
  ...
  Future<void> _assignDocument() async {
    ...
    try {
      // TODO: Implement actual assignment logic with repository
