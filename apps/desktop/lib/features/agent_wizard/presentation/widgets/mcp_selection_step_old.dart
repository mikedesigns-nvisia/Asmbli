...
class _MCPSelectionStepState extends ConsumerState<MCPSelectionStep> {
          ...
          child: Column(
            ...
            children: [
              ...
              if (_showRecommendations) ...[
                _buildRecommendationsSection(context, catalogEntries),
                const SizedBox(height: SpacingTokens.xxl),
              ],
              
              _buildSelectedServersSection(context, agentConfigs, catalogEntries),
              const SizedBox(height: SpacingTokens.xxl),
              
              _buildBrowseCatalogSection(context),
            ],
          ),
        ),
      ),
  ...
  Widget _buildRecommendationsSection(BuildContext context, List<MCPCatalogEntry> catalogEntries) {
